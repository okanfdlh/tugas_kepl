          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{route('dokumen.index')}}" class="nav-link {{ Request::routeIs('dokumen.index') ? 'active' : '' }}">
                    <i class="nav-icon fas fa-list"></i>
                    <p>
                      Dokumen
                    </p>
                ...
                <li class="nav-item">
                  <a href="{{route('logout')}}" class="nav-link {{ Request::routeIs('datagempa') ? 'active' : '' }}">
                    <i class="nav-icon fas fa-list"></i>
                    <p>
                      Logout
                    </p>
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{route('arsip.index')}}" class="nav-link {{ Request::routeIs('arsip.index') ? 'active' : '' }}">
                    <i class="nav-icon fas fa-th"></i>
                    <p>
                      Kelola Dokumen
                    </p>
